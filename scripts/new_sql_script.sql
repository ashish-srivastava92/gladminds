...
alter table gm_partindex_details change column quantity_street quantity_variant2 int(11)
alter table gm_orderpart_details add column part_number_catalog_id int(11) NULL
