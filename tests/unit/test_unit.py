...
#         customer_obj = self.get_customer_obj(phone_number='+919999999', name='TestCustomer')
#         product_obj = self.get_product_obj(product_id="VINXXX001", product_type=self.product_type_obj, dealer_id=dealer_obj\
#                                            , purchase_date=datetime.now(), customer_details=customer_obj, customer_id='SAP001')
...
class TestFeedLogWithRemark(ResourceTestCase):
    ...
    def test_remarks(self):
        ...
        resp = api_client.post(url, data=xml_data,
