...
sudo crontab -l | (cat;echo "00 19 * * *  python /opt/app/gladminds/src/gladminds/trigger_sqs_tasks.py export_coupon_redeem_to_sap gladminds-qa") | sudo  crontab
...
sudo crontab -l | (cat;echo "00 00 * * *  python /opt/app/gladminds/src/gladminds/trigger_sqs_tasks.py export_coupon_redeem_to_sap gladminds-prod") | sudo  crontab
