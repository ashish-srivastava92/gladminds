...
export LE_ACCOUNT_KEY="$2"

# provide a list of logs that logentries agent should follow
declare -a LOGS_TO_FOLLOW=(
/var/log/gladminds/sql.log
/var/log/gladminds/gladminds.log
/var/log/gladminds/afterbuy.log
/var/log/gladminds/test_case.log
...
REGISTER_CMD="le register --hostname=$APPNAME:$HOSTNAME:$DATE --force"
