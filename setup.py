...
setup(
    ...
    package_dir={'': 'src'},
    install_requires=['setuptools', 'Django==1.6.4', 'celery==3.1.15', 'MySQL-python>=1.2.4', 'gunicorn==18.0', 'django-suit==0.2.8', 
                      'django-tastypie==0.11.0', 'requests', 'redis==2.9.1', 'flower==0.6.0', 'south==0.8.4', 
                      'django-celery==3.1.10','parse==1.6.4', 'django-twilio==0.5.1','django-import-export==0.2.2', 
                      ...
                      'django-debug-toolbar==1.2.1','django-extensions==1.2.5'],
)
