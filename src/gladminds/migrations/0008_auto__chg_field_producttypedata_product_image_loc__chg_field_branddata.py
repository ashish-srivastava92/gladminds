...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'ProductTypeData.product_image_loc'
        db.alter_column(u'gladminds_producttypedata', 'product_image_loc', self.gf('django.db.models.fields.files.FileField')(default=datetime.datetime(2014, 9, 23, 0, 0), max_length=100))
