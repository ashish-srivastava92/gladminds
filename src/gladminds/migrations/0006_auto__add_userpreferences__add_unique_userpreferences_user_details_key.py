...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'gladminds_userpreferences', (
            ...
            ('user_details', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gladminds.UserProfile'])),
            ('key', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('value', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('gladminds', ['UserPreferences'])

        # Adding unique constraint on 'UserPreferences', fields ['user_details', 'key']
        db.create_unique(u'gladminds_userpreferences', ['user_details_id', 'key'])


    def backwards(self, orm):
        # Removing unique constraint on 'UserPreferences', fields ['user_details', 'key']
        db.delete_unique(u'gladminds_userpreferences', ['user_details_id', 'key'])
    ...
    models = {
        ...
        'gladminds.producttypedata': {
            ...
            'warranty_phone': ('django.db.models.fields.CharField', [], {'max_length': '15', 'null': 'True', 'blank': 'True'})
        },
