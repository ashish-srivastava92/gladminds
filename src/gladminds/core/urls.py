...
urlpatterns = patterns('',
    ...
    url(r'^api/v1/redeem-feed/$', 'gladminds.core.services.feed_views.views_coupon_redeem_wsdl', {'document_root': settings.WSDL_COUPON_REDEEM_LOC}),
    url(r'^api/v1/customer-feed/$', 'gladminds.core.services.feed_views.views_customer_registration_wsdl', {'document_root': settings.WSDL_CUSTOMER_REGISTRATION_LOC}),
    ...
    url(r'^aftersell/reports/(?P<report>[a-zA-Z0-9]+)$', 'gladminds.core.views.reports'),
    ...
    url(r'^aftersell/servicedesk/$', 'gladminds.core.services.service_desk.get_servicedesk_tickets', name='get_servicedesk_tickets'),
    url(r'^aftersell/feedbackdetails/(?P<feedback_id>\d+)/$', 'gladminds.core.services.service_desk.modify_servicedesk_tickets', name='modify_servicedesk_tickets'),
    url(r'^aftersell/feedbackresponse/(?P<feedback_id>\d+)/$', 'gladminds.core.services.service_desk.get_feedback_response', name='get_feedback_response'),
)