...
urlpatterns = patterns('',
    ...
    url(r'^get_retailer_profile/retailer_id/(?P<retailer_id>\d+)/$',
                                                'gladminds.bajaj.views.apis.get_retailer_profile'),
    url(r'^get_parts/', 'gladminds.core.views.apis.get_parts'),
    ...
    url(r'^get_outstanding/retailer_id/(?P<retailer_id>\d+)/$',
                                             'gladminds.core.views.apis.get_outstanding'),
    url(r'^get_schedule/dsr_id/(?P<dsr_id>\d+)/date/(?P<date>[-\d]+)/$',
