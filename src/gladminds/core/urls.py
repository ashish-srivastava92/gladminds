...
#                         'gladminds.bajaj.views.apis.day_close_order'),
    ...
    #end of mc urls
    url(r'^cv/get_parts/', 'gladminds.bajaj.views.apis.get_parts'),
    url(r'^cv/get_associated_parts/', 'gladminds.core.views.apis.get_associated_parts'),
    url(r'^cv/api-token-auth/', 'gladminds.bajaj.views.apis.authentication'),
    url(r'^cv/get_retailers/dsr_id/(?P<dsr_id>\d+)/$', 'gladminds.bajaj.views.apis.get_retailers'),
    url(r'^cv/get_retailer_profile/retailer_id/(?P<retailer_id>\d+)/$',
                                                'gladminds.bajaj.views.apis.get_retailer_profile'),
    
    # url(r'^cv/order/$', 'gladminds.bajaj.views.apis.retailer_order'),
