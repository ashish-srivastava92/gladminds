...
def get_message_template_mapper():
    return {
            settings.ALLOWED_KEYWORDS['register']: {
                           ...
                           'handler': 'free_service_coupon.register_customer',
                           'auth_rule': ['open']
                                                   },
            settings.ALLOWED_KEYWORDS['service']:{
                           ...
                           'handler':'free_service_coupon.customer_service_detail',
                           'auth_rule': ['customer']
                           },
            settings.ALLOWED_KEYWORDS['check']:{
                         ...
                         'handler':'free_service_coupon.validate_coupon',
                         'auth_rule': ['sa']
                         },
            ...
            settings.ALLOWED_KEYWORDS['brand']:{
                        ...
                        'invalid':get_template('SEND_INVALID_MESSAGE'),
                        'handler':'free_service_coupon.get_brand_data',
                        'auth_rule': ['open']
                         },
            settings.ALLOWED_KEYWORDS['customer_detail_recovery']:{
                        ...
                        'invalid':get_template('SEND_INVALID_MESSAGE'),
                        'handler':'free_service_coupon.send_customer_detail',
                        'auth_rule': ['open']
                         },
            settings.ALLOWED_KEYWORDS['service_desk']:{
                        ...
                        'invalid':get_template('SEND_INVALID_MESSAGE'),
                        'handler':'service_desk.get_complain_data',
                        'auth_rule': ['open']
                        },
            settings.ALLOWED_KEYWORDS['accumulate_point']:{
                        ...
                        'invalid':get_template('SEND_INVALID_MESSAGE'),
                        'handler':'loyalty.accumulate_point',
                        'auth_rule': ['open']},
