...
class Mechanic(BaseModel):
    ...
    phone_number = PhoneField(skip_check=True, null=True, blank=True, verbose_name='Phone number *')
    ...
    shop_name = models.CharField(max_length=50, null=True, blank=True, verbose_name='Shop name *')
    ...
    district = models.CharField(max_length=50, null=True, blank=True, verbose_name='District *')
    state = models.CharField(max_length=50, null=True, blank=True, verbose_name='State *')
    pincode = models.CharField(max_length=50, null=True, blank=True, verbose_name='Pincode *')
