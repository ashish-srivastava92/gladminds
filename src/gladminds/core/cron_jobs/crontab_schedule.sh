sudo crontab -r
sudo crontab -l | (cat;echo "*/5 * * * *  python /opt/app/gladminds/src/gladminds/core/cron_jobs/trigger_sqs_tasks.py send_reminders_for_servicedesk gladminds-qa2") | sudo crontab
...
sudo crontab -l | (cat;echo "00 00 * * *  python /opt/app/gladminds/src/gladminds/core/cron_jobs/trigger_sqs_tasks.py send_mail_for_policy_discrepency gladminds-qa2") | sudo crontab 
...
sudo crontab -l | (cat;echo "00 18 * * *  python /opt/app/gladminds/src/gladminds/core/cron_jobs/trigger_sqs_tasks.py export_purchase_feed_sync_to_sap gladminds-prod2") | sudo crontab
...
sudo crontab -l | (cat;echo "00 20 * * *  python /opt/app/gladminds/src/gladminds/core/cron_jobs/trigger_sqs_tasks.py send_mail_for_policy_discrepency gladminds-prod2") | sudo crontab 
