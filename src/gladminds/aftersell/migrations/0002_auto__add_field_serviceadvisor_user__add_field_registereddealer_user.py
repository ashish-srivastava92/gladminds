...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ServiceAdvisor.user'
        db.add_column(u'aftersell_serviceadvisor', 'user',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['gladminds.UserProfile'], unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'RegisteredDealer.user'
        db.add_column(u'aftersell_registereddealer', 'user',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['gladminds.UserProfile'], unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ServiceAdvisor.user'
        db.delete_column(u'aftersell_serviceadvisor', 'user_id')

        # Deleting field 'RegisteredDealer.user'
        db.delete_column(u'aftersell_registereddealer', 'user_id')
