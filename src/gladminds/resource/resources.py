...
class GladmindsResources(Resource):
    ...
    def dispatch_gladminds(self, request, **kwargs):
        ...
        try:
            ...
            send_invalid_keyword_message.delay(
            ...
            raise ImmediateHttpResponse(
                HttpBadRequest("Invalid Message Format"))
    ...
    def register_customer(self, sms_dict, phone_number):
        ...
        try:
            ...
            customer.save()
        message = templates.get_template('SEND_CUSTOMER_REGISTER').format(
            customer_name=customer_name, customer_id=gladmind_customer_id)
