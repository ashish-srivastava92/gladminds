...
def get_servicedesk_users(**filters):
    return common.UserProfile.objects.filter(**filters)
...
#     else:
#         servicedesk_assign_obj = common.UserProfile.objects.filter(
...
#         servicedesk_obj_all = common.UserProfile.objects.filter(
#                                                     designation='SDM')
