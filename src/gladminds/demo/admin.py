...
from gladminds.demo import models
from django.contrib.admin.options import ModelAdmin, TabularInline
from gladminds.core.core_utils.utils import get_search_query_params
...
class ListDispatchedProduct(ModelAdmin):
    ...
    def queryset(self, request):
        ...
        """
        get_search_query_params(request, self)
...
class CouponAdmin(ModelAdmin):
    ...
    def queryset(self, request):
        ...
        admin site. This is used by changelist_view.
        """
        if get_search_query_params(request, self) and self.search_fields[0] == 'status':
            try:
                request.GET = request.GET.copy()
                search_value = str(COUPON_STATUS[request.GET["q"]])
...
def get_admin_site_custom(brand):
    ...
    brand_admin.register(models.DispatchedProduct, ListDispatchedProduct)
