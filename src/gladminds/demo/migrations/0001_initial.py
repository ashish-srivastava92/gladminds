...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'demo_oldfscdata', (
            ...
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['demo.ProductData'])),
            ('servicing_dealer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['demo.Dealer'], null=True, blank=True)),
        ))
        ...
        db.create_table(u'demo_userpreferences', (
            ...
            ('user_profile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['demo.UserProfile'])),
        ))
        db.send_create_signal('demo', ['UserPreferences'])

        # Adding unique constraint on 'UserPreferences', fields ['user_profile', 'key']
        db.create_unique(u'demo_userpreferences', ['user_profile_id', 'key'])
    ...
    def backwards(self, orm):
        ...
        db.delete_unique(u'demo_userpreferences', ['user_profile_id', 'key'])
    ...
    models = {
        ...
        'demo.oldfscdata': {
            ...
            'servicing_dealer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['demo.Dealer']", 'null': 'True', 'blank': 'True'}),
            'special_case': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'status': ('django.db.models.fields.SmallIntegerField', [], {'default': '1', 'db_index': 'True'}),
        ...
        'demo.userpreferences': {
            ...
            'modified_date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'user_profile': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['demo.UserProfile']"}),
