...
def import_serviceadvisor_data(sa_source):
    for sa in sa_source:
        try:
            ...
            print "Getting exception in sa type: %s " % ex
            continue

def import_productdata(product_source):
    for product in product_source:
        try:
            print "Saving product data:" % product
            ...
            print "Getting exception in product data: %s " % ex
            continue

def import_coupondata(coupon_source):
    for coupon in coupon_source:
        try:
            print "Saving coupon data: %s" % coupon
            ...
            print "sa_phone_number: %s" % sa_phone_number
            ...
            print "Getting exception in coupon data: %s " % ex
            continue