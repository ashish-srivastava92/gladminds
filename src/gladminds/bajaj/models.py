...
class Feedback(base_models.Feedback):
    ...
    assign_to = models.ForeignKey(ContentType, related_name='bajaj feedback assignee', null=True, blank=True)
...
class FeedbackEvent(base_models.FeedbackEvent):
    ...
    user_details = models.ForeignKey(ContentType, related_name='bajaj feedback event users', null=True, blank=True)
