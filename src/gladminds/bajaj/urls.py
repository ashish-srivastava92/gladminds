...
urlpatterns = patterns('',
    ...
    url(r'^upload_transit_stock/$', 'gladminds.bajaj.views.upload_transit_stock',name="upload_transit_stock"),
...
#                    name='invoice'),
    ...
    url(r'^download_sample_transit_stock_csv/', 'gladminds.bajaj.views.views.download_sample_transit_stock_csv',
                   name='download_sample_transit_stock_csv'),
