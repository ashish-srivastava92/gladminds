...
brand_admin.register(models.BrandVertical)
brand_admin.register(models.BOMHeader)
brand_admin.register(models.BrandProductRange)
brand_admin.register(models.BOMPart)
brand_admin.register(models.BOMPlate)